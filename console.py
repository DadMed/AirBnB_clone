...
<<<<<<< HEAD
=======
Command-line interface module for HBNB Console
>>>>>>> 115bc1f7b03b74f49cb2f55fd8840d39cc8119f4
"""
import cmd
import re
import shlex
...
def split_curly_braces(e_arg):
    """
    Helper function to split curly braces for the update method
    """
...
<<<<<<< HEAD
=======
    HBNBCommand console class for managing HBNB console commands
>>>>>>> 115bc1f7b03b74f49cb2f55fd8840d39cc8119f4
    """
    prompt = "(hbnb) "
    ...
    def do_EOF(self, arg):
        """
        Handle EOF (Ctrl+D) signal to exit the program.
        """
        return True
